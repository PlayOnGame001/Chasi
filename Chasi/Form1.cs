...
namespace Chasi
{
    public partial class Form1 : Form
    {
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            g.DrawString("3", font, Brushes.Black, 280, pictureBox1.Height / 2 - 5);
            g.DrawString("9", font, Brushes.Black, 55, pictureBox1.Height / 2 - 5);
            g.DrawEllipse(Pens.Black, pictureBox1.Width / 7, pictureBox1.Height / 7, 250, 250);
            ...
            g.FillEllipse(Brushes.Black, pictureBox1.Width / 2 - 4, pictureBox1.Height / 2 - 4, 5, 8);

            Font font_time = new Font("Arial", 20);
            gr.DrawRectangle(Pens.Black, pictureBox2.Width / 5, 0, 200, 45);
            gr.DrawString(time.ToLongTimeString(), font_time, Brushes.Black, 120, 15);
